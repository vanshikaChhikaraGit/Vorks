...
const page = () => {
  return (
    <div>
        Privacy Policy for Vorks
At Website Name, accessible at https://vorks.vercel.app/, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Website Name and how we use it.
